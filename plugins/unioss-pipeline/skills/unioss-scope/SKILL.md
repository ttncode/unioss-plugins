...
1. **Check for an existing file.** If `.walkthrough/<PREFIX>-[IID]/scope.md` exists, read it first — you are updating it, not starting fresh. Keep objectives/content that are still true; only add/remove what this round actually changed.
...
9. Save (overwrite) `.walkthrough/<PREFIX>-[IID]/scope.md`.
