...
- **Coder-integrated (pipeline):** the coder invokes this skill when the approved change adds an endpoint → write `round-<N>/<PREFIX>#[IID]_API_SPEC.md`, return its backticked relative path.
