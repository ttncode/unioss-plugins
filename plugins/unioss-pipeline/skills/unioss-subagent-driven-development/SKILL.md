...
- At skill start, check for a ledger:
  `cat "$(git rev-parse --show-toplevel)/.walkthrough/.pipeline/sdd/progress.md"`. Tasks listed there
...
[Read plan file once: .walkthrough/plans/feature-plan.md]
...
You: "User level (~/.config/unioss/hooks/)"
...
- **unioss-pipeline:unioss-executing-plans** - Use for parallel session instead of same-session execution
