...
- The changes manifest path `round-<N>/changes.md` (+ `_api-spec.md` if present).
...
2. **Write only `scope.md` — never touch project source, and never write into a `round-<N>/` subfolder.**

## Output

- The backticked absolute path to `scope.md`.
