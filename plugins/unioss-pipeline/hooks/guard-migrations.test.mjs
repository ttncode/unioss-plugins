...
test('authorizingPlanFiles uses only the latest round of the active ticket', () => {
  ...
  writeFileSync(join(root, 'AP-9', 'round-1', 'implementation.v1.md'), 'no match here');
  mkdirSync(join(root, 'AP-9', 'round-2'), { recursive: true });
  writeFileSync(join(root, 'AP-9', 'round-2', 'implementation.v1.md'), 'touches 099_add_col.php');
